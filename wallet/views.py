...
def dashboard(request):
    ...
    userv=request.user.id
    t = models.UserProfileInfo.objects.get(user__id=userv)
    # y = models.UserProfileInfo.objects.get(user=t)
    # bal
    # print(user.is_authenticated)
    return render(request,"wallet/dashboard.html",{'user':userv})
